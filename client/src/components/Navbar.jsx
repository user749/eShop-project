import { Box, Flex, HStack, Link, Icon, Text, useDisclosure, Button, Stack, useColorMode,useColorModeValue, IconButton} from "@chakra-ui/react"
  ...
  return (
    <Box bg={useColorModeValue("grey.100", "grey.900")} px={4}>
        <Flex h={16} alignItems={"center"} justify={"space-between"}>
            ...
            <Button as={ReactLink} to="/registration" m={2} display={{base:"none", md: "inline-flex"}}
            fontSize={"sm"} fontWeight={600} _hover={{bg: "green.400"}} bg={"green.500"} color={"white"}> 
                Sign-up
            </Button>
