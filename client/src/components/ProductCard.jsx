  ...
  return (
    <Flex>
      <HStack spacing={"2px"}>
        ...
        <StarIcon size={iconSize} w={"14px"} color={rating >= 2 ? "orange.400" : "gray.200"} />
        <StarIcon size={iconSize} w={"14px"} color={rating >= 3 ? "orange.400" : "gray.200"} />
        <StarIcon size={iconSize} w={"14px"} color={rating >= 4 ? "orange.400" : "gray.200"} />
